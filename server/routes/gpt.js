...
// Router endpoint to analyze the image
router.post('/analyze-image', async (req, res) => {
  try {
    ...
    const outputImagePath = "./resized_image.png"; // Temporary path for the resized image

    // Get the Base64-encoded image
    const base64Image = await encodeImage(imagePath, outputImagePath);
      ...
      messages: [
        {
          role: "user",
          content: [
            { type: "text", text: "Give me details of this image?" },
            {
              type: "image_url",
              image_url: {
...
// normal text serach with ChatGpt
